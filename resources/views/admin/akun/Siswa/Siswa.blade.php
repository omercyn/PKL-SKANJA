            ...
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                            <a href="{{ route('siswa-akun.create') }}">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Tabel Akun Siswa</h5>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($user as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="POST"
                                                        action="{{ route('siswa-akun.destroy', $item->id) }}">
                                                        @csrf
                                                        @method('DELETE')
                                                    ...
                                                    <a href="{{ route('siswa-akun.edit', $item->id) }}">
                                                        <button type="button">Edit</button>
                                                    </a>
                                                    <a href="{{ route('siswa-akun.show', $item->id) }}">
