...
<body>
        ...
        <header class="navbar navbar-expand-md d-print-none">
            <div class="container-xl">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href=".">
                        <img src="{{ asset('static/YUK.svg') }}" alt="Tabler" class="navbar-brand-image">
                    </a>
                </h1>
                        ...
                        <ul class="navbar-nav">
                                ...
                                <div class="dropdown-menu">
                                    <div class="dropdown-menu-columns">
                                        <div class="dropdown-menu-column">
                                            ...
                                            <a class="dropdown-item" href="{{ route('guru-akun.index') }}">
                                                Guru Pembimbing
                                            </a>
                                            <a class="dropdown-item" href="{{ route('siswa-akun.index') }}">
                                                Siswa
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <div class="dropdown-menu-columns">
                                        <div class="dropdown-menu-column">
                                            <a class="dropdown-item" href="{{ route('rekap.index') }}">
                                                Rekap Harian
                                            </a>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function validasiInput(inputElement) {
            // Regex for only numbers and spaces
            const regex = /[^0-9 ]/g;
            // Replace non-matching characters with empty string
    ...
    <script>
        ...
        var guruPembimbingInput = document.getElementById('guruPembimbing');

        lokasiSelect.addEventListener('change', function() {
            var selectedOption = lokasiSelect.options[lokasiSelect.selectedIndex];
            var guruPembimbing = selectedOption.getAttribute('data-guru');
            guruPembimbingInput.value = guruPembimbing;
        });
    </script>
</body>
