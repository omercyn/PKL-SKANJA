...
@section('title', 'Yuk Absen | Data Akun Superadmin')
                    ...
                    <div class="col d-flex flex-column">
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <img id="avatar-preview" class="avatar avatar-xl"
                                        src="{{ asset('storage/foto-profil/' . Auth::user()->profil) }}">
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="mt-1 small text-muted">{{ Auth::user()->NIP }}</div>
                                </div>
                                <div class="col-md">
                                    <div class="form-label">No. Handphone</div>
                                    <div class="mt-1 small text-muted">{{ Auth::user()->HP }}</div>
                                </div>
                            </div>
